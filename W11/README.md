# Module 5 Week 11 - Database Design
...
- Choosing the perfect data type is less of a concern nowadays because memory is now comparably cheap. Thee focus is more on performance
...
### ERD Practice Example
Convert Gyms spreadsheet into an ERD:
![image info](./media/gym_info.png)

Possible solution: 
![image info](./media/gym_locations_ERD.png)
